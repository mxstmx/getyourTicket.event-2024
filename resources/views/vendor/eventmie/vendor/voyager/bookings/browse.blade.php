@php use Classiebit\Eventmie\Models\Transaction; @endphp
...
@section('page_header')
    <div class="container-fluid">
        ...
        <a href="{{route('failed-bookings.index')}}" class="btn btn-danger" id="bulk_delete_btn"></i> <span>{{ __('eventmie-pro::em.failed').' '.__('eventmie-pro::em.bookings') }}</span></a>
    </div>
@stop
                            ...
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        @endforeach
                                        <th> {{ __('eventmie-pro::em.transaction_id') }} </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            <a href="{{ route('voyager.bookings.send_email',[$data->id])}}" class="btn btn-sm btn-success pull-right">
                                                <i class="voyager-paper-plane"></i> <span class="hidden-xs hidden-sm">{{ __('eventmie-pro::em.send') }}</span>
                                            </a>
