                        ...
                        <div class="panel-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <label class="custom-control"
                                                id="event_id_label">{{ __('eventmie-pro::em.search_and_select_event') }}</label>
                                        ...
                                        <div class="form-group">
                                            <label class="custom-control"
                                                id="ticket_lable">{{ __('eventmie-pro::em.select') . ' ' . __('eventmie-pro::em.ticket') }}</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="custom-control"
                                            id="event_id_label">{{ __('eventmie-pro::em.search') }}</label>
                                        <input type="search" class="form-control" name="search" id="search"
                                            placeholder="{{ __('eventmie-pro::em.search') }}" onkeypress="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form
                                        action="{{ $isOrgDash ? route('eventmie.export_sales_report') : route('voyager.export_sales_report') }}"
                                        method="POST">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        ...
                                        <button type="submit" id="export_button" class="btn lgx-btn btn-block"><i
                                            ...
                                            {{ __('eventmie-pro::em.export_sales_report') }} CSV </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="custom-control"
                                            id="event_id_label1">{{ __('eventmie-pro::em.search_and_select_event') }}</label>
            ...
            $('#sales_report').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        name: 'checked_in',
                        render: function(data, type, row) {
                            return row.checked_in > 0 ? "@lang('eventmie-pro::em.yes')" + " (" + row.checked_in + "/" +
                                row.quantity + ")" : "@lang('eventmie-pro::em.no')"
                        }
                    },
                    {
                        data: 'ticket_price',
...

                    {
                        ...
                        render: function(data, type, row) {
                            return (row.transferred <= 0 && row.organiser_earning > 0) ?
                                "@lang('eventmie-pro::em.pending')" : "@lang('eventmie-pro::em.transferred')";
                        }
                    },
                ],
            ...
            $.ajax(url, {
                ...
                success: function(res, status, xhr) { // success callback function
                    ...
                    if (res.status) {
                        ...
                        mySelect.append(
                            $('<option></option>').val({!! json_encode(__('eventmie-pro::em.all')) !!}).html(
                                {!! json_encode(__('eventmie-pro::em.all')) !!})
                        );
            ...
            fetch(`${url}?event_title=${event_title}`)
                ...
                .then(data => {
                    ...
                    if (data.length <= 0) {
                        const option = document.createElement('option');
                        option.value = '';
                        option.textContent = "{{ __('eventmie-pro::em.not_found') }}";
                        myDropdown.appendChild(option);
                    }
