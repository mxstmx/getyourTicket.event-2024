                                    ...
                                    @if(!empty($commissions))
                                        @foreach($commissions as $key => $data)
                                            <form method="POST"  action="{{route('eventmie.commission_update')}}" class="form-search">
                                                ...
                                                <input type="hidden" class="form-control" name="currency" value="{{$data->currency}}">
                                                        
                                                    <td>{{ $data->event_name }}</td>
                                                    <td>{{ $data->organiser_name }}</td>
                                                    <td>{{ $data->customer_paid_total}} {{ $data->currency }}</td>
                                                    <td>{{ $data->admin_commission_total }} {{ $data->currency }}</td>
                                                    <td>{{ $data->admin_tax_total }} {{ $data->currency }}</td>
                                                    <td>{{ $data->organiser_earning_total }} {{ $data->currency }}</td>
