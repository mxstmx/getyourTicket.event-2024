...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="blogDropdown">
        ...
        @if (Auth::user()->hasRole('customer'))
            ...
            <li class="nav-item dropdown ">
                <a class="dropdown-item" href="{{ route('eventmie.profile') }}#/becomeOrganiser"><i
        ...
        @if (Auth::user()->hasRole('admin'))
            ...
            {{-- CUSTOM CUSTOM --}}
            <li class="nav-item dropdown">
                <a class="dropdown-item" href="{{ route('failed-bookings.index') }}"
                    title="@lang('eventmie-pro::em.failed') @lang('eventmie-pro::em.bookings')">
