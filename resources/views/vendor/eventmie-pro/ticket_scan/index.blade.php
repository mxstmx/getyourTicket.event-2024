                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    ...
                                    <form id="form" action="{{ route('eventmie.verify_ticket') }}" method="POST"
                                        ...
                                        <div class="form-group row mt-5" id="dropdown">
                                            <label class="col-md-3" for="attendee_id">@lang('eventmie-pro::em.select')
                                                @lang('eventmie-pro::em.attendee')</label>
                                            <div class="col-md-9">
...
@section('javascript')
    <script type="text/javascript" src="{{ mix('js/ticket_scan.js') }}"></script>
