            ...
            <div class="col-xl-12 col-md-12 col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header d-flex justify-content-between flex-wrap p-4 bg-white border-bottom-0">
                        ...
                        <div>
                            <a class="btn btn-secondary btn-block" href="{{ route('eventmie.myevents_index') }}"><span><i
                                        class="fas fa-xmark"></i> @lang('eventmie-pro::em.cancel')</span></a>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <router-view :is_admin="{{ json_encode(Auth::user()->hasRole('admin')) }}"
                            :organisers="{{ json_encode($organisers, JSON_HEX_APOS) }}" :organiser_id="{{ $organiser_id }}"
...
@section('javascript')
    ...
    <script type="text/javascript" src="{{ mix('js/events_manage.js') }}"></script>
@stop
