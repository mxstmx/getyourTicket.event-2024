                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <h1
                                    ...
                                    <p style="margin:0;">@lang('eventmie-pro::em.start_purchasing')</p><br>
                                    
                                    @if(!empty($mail['guest_checkout']))
                                        <ul class="list-group " style="list-style: none">
                                            <li style="margin:0;">@lang('eventmie-pro::em.guest_info',['app_name' => env('APP_NAME')])</li>
                                            <li style="margin:0;">@lang('eventmie-pro::em.click_here_to_login') <a href="{{route('eventmie.login')}}">@lang('eventmie-pro::em.login')</a></li>
                                            <li style="margin:0;">@lang('eventmie-pro::em.email'): {{ auth()->user()->email }}</li>
                                            <li style="margin:0;">@lang('eventmie-pro::em.password'): {{ $mail['guest_password'] }}</li>
