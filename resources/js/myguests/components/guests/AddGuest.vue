<template>
    ...
    <div class="custom_model">
        ...
        <div class="modal show" v-if="add_guest > 0">
            <div class="modal-dialog modal-lg w-100">
                <div class="modal-content lgx-modal-box">
                    <div class="modal-header">
                        <h1 class="modal-title fs-3"> {{ trans('em.create')+' '+trans('em.guest') }}</h1>
                    ...
                    <div class="modal-body">
                            ...
                            <input type="hidden" class="form-control " v-model="guest_id" name="guest_id" >
                            ...
                            <div class="mb-3">
                                <label class="form-label">{{ trans('em.add_to_guestlist') }}</label>
                                <multiselect
