                    ...
                    <form ref="form" @submit.prevent="cropThumbnailPoster" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3" >
                           <label class="form-label">YouTube {{ trans('em.video_url') }} ({{ trans('em.optional') }})</label>
                            <div class="col-md-6">
                               <button type="button" class="btn btn-sm btn-primary" @click="addMore += 1">
                                   <i class="fas fa-plus-circle" aria-hidden="true"></i> {{ trans('em.add_more') }}
                                </button>

                                <button type="button" class="btn btn-sm btn-danger" @click="addMore += -1" v-if="addMore > 1">
                                    <i class="fas fa-minus-circle" aria-hidden="true"></i> {{ trans('em.remove') }}
                                </button>
                                <br>
                                <br>

        
                                <input v-for=" (itm, ind) in addMore" :key="ind" type="text" class="form-control mb-1" name="video_link[]" placeholder="e.g Zjq1zRWpcgs"  v-model="video_link[ind]" @change="isDirty()">
                        ...
                        <!-- CUSTOM -->
                        <div class="mb-3">
                            <label class="form-label">{{ trans('em.seatingchart_image') }}</label>
                            <div class="col-md-12">
                             ...
                             <div class="w-100">
                                <div class="row" v-if="event.seatingchart_image != null">
                                    <div class="col-sm-3 col-lg-1 pb-1" style="position:relative;">
                                        ...
                                        <img :src="'/storage/'+event.seatingchart_image" class="img-fluid img-rounded">
                                    </div>
                                </div>
                            </div>
                        </div>    
