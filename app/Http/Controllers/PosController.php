...
class PosController extends Controller
{
    ...
    public function index()
    {
        ...
        $path = !empty($path) ? $path.'/dashboard/pos-bookings/index' : '/dashboard/pos-bookings/index';
        
        // show organiser_bookings for pos organizer
        return view('vendor.eventmie-pro.bookings.organiser_bookings', compact('path', 'is_success', 'extra'));
