                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $dataTypeContent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <?php if($showCheckboxColumn): ?>
                                            <td>
                                        ...
                                        <?php $__currentLoopData = $dataType->browseRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td>
                                                ...
                                                <?php elseif($row->type == 'relationship'): ?>
                                                    ...
                                                    <?php if( !empty($data->organisation) && $data->role_id == 2): ?>
                                                    <span class="badge badge-info"><?php echo app('translator')->get('eventmie-pro::em.requested_to_become_organiser'); ?></span>
                                                    <?php endif; ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/getyourticket.events/httpdocs/public/eventmie-pro/src/../resources/views/vendor/voyager/users/browse.blade.php ENDPATH**/ ?>