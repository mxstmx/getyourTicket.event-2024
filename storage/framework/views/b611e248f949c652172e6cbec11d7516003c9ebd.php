<?php $__env->startSection('page_title', 'Bulk Bookings'); ?>
                            ...
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <?php $__currentLoopData = $dataType->browseRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <th>
                                                <?php if($isServerSide): ?>
                                                        ...
                                                        <?php if($sortOrder == 'asc'): ?>
                                                            <a href="<?php echo e(url('admin/bookings/bulk?sort_order=desc&order_by=bulk_code')); ?>">
                                                            
                                                            <?php echo e(__('eventmie-pro::em.bulk_code')); ?>

                                                            <i class="voyager-angle-up pull-right"></i>
                                                        <?php else: ?>
                                                            <a href="<?php echo e(url('admin/bookings/bulk?sort_order=asc&order_by=bulk_code')); ?>">
                                                                <?php echo e(__('eventmie-pro::em.bulk_code')); ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?php echo e($data->bulk_code); ?> </td>
                                        <?php $__currentLoopData = $dataType->browseRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <td>
                                                ...
                                                <?php elseif($row->type == 'text'): ?>
                                                    ...
                                                    <?php if($row->display_name == 'Quantity'): ?>
                                                        <div>
                                                            <?php echo e($data->bulk_quantity); ?>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            <a href="<?php echo e(route('voyager.bookings.bulk_edit',[$data->id])); ?>" class="btn btn-sm btn-info edit pull-right">
                                                <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm"><?php echo e(__('voyager::generic.edit')); ?></span>
                                            </a>

                                            <a href="<?php echo e(route('voyager.bookings.bulk_show',[$data->id])); ?>" class="btn btn-sm btn-warning view pull-right">
                                                <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm"><?php echo e(__('voyager::generic.view')); ?></span>
                                            </a>

                                            <a href="<?php echo e(route('voyager.bookings.bulk_zip',[$data->ticket_id, $data->bulk_code])); ?>" class="btn btn-sm btn-success download pull-right">
                                                <i class="voyager-download"></i> <span class="hidden-xs hidden-sm"><?php echo e(__('eventmie-pro::em.download_zip')); ?></span>
                                            </a>

                                            <a href="<?php echo e(route('voyager.bookings.bulk_export',[$data->ticket_id, $data->bulk_code])); ?>" class="btn btn-sm btn-success download pull-right">
                                                <i class="voyager-download"></i> <span class="hidden-xs hidden-sm"><?php echo e(__('eventmie-pro::em.export_attendees')); ?></span>
                                            </a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form action="<?php echo e(route('voyager.bookings.bulk_delete',[$data->id])); ?>" id="delete_form" method="GET">
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/getyourticket.events/httpdocs/public/resources/views/vendor/eventmie-pro/vendor/voyager/bookings/bulk.blade.php ENDPATH**/ ?>