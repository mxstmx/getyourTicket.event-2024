                ...
                <div class="page-content settings container-fluid">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="<?php echo e(\Illuminate\Support\Str::slug($group)); ?>" class="tab-pane fade in <?php if($group == $active): ?> active <?php endif; ?>">
                            ...
                            <?php if($setting->key == 'apps.google_client_id'): ?>
                            <br>
                            <div class="alert alert-info">
                                <?php echo e(__('voyager::generic.Set Callback URL on your Google App Dashboard')); ?> - <code><?php echo e(route('eventmie.oauth_callback', ['social' => 'google'])); ?></code>
                            </div>
                            <?php endif; ?>

                            
                            <?php if($setting->key == 'apps.facebook_app_id'): ?>
                            <br>
                            <div class="alert alert-info">
                                <?php echo e(__('voyager::generic.Set Callback URL on your Facebook App Dashboard')); ?> - <code><?php echo e(route('eventmie.oauth_callback', ['social' => 'facebook'])); ?></code>
                            </div>
                            <?php endif; ?>

                            
                            <?php if($setting->key == 'apps.paypal_client_id'): ?>
                            <br>
                            <div class="alert alert-info">
                                <?php echo e(__('voyager::generic.Set Callback URL on your PayPal Dashboard')); ?> - <code><?php echo e(route('eventmie.bookings_paypal_callback')); ?></code>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="panel-heading">
                                ...
                                <?php if(config('voyager.pkg_dev_mode')): ?> 
                            ...
                            <div class="panel-body no-padding-left-right">
                                <div class="col-md-10 no-padding-left-right">
                                    ...
                                    <?php elseif($setting->type == "password"): ?>
                                        <input type="password" class="form-control" name="<?php echo e($setting->key); ?>" value="<?php echo e($setting->value); ?>">
                                    ...
                                    <small class="form-text text-muted"><?php echo e($options->description); ?></small>
                                    <?php endif; ?>
                                ...
                                <div class="col-md-2 no-padding-left-right">
                                    ...
                                    <?php else: ?>
                                        <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($setting->group == $group): ?>
                                                <input type="hidden" name="<?php echo e($setting->key); ?>_group" value="<?php echo e($group); ?>">
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php endif; ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/getyourticket.events/httpdocs/public/eventmie-pro/src/../resources/views/vendor/voyager/settings/index.blade.php ENDPATH**/ ?>