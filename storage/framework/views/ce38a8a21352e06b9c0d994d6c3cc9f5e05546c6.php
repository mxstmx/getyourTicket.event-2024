                            ...
                            <td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
                                <a href="<?php echo e(eventmie_url()); ?>" style="text-decoration:none;">
                                    ...
                                    <h1
                                        ...
                                        <?php echo e((setting('site.site_name') ? setting('site.site_name') : config('app.name'))); ?></h1>
                                    <h5
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <h1
                                    ...
                                    <?php echo e($mail['mail_subject']); ?></h1>
                                <p style="margin:0;"><?php echo e($mail['mail_message']); ?></p>
                            </td>
                        </tr>
                                    ...
                                    <table style="width:100%;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                                        <tr>
                                            <td
                                                ...
                                                <?php echo app('translator')->get('eventmie-pro::em.name'); ?></td>
                                            <td
                                                style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;">
                                                <?php echo e($mail['user']['name']); ?></td>
                                        </tr>
                                        <tr>
                                            <td
                                                style="padding: 10px; border-bottom: 1px solid #ededed; width: 35%; font-weight:500; color:rgba(0,0,0,.64)">
                                                <?php echo app('translator')->get('eventmie-pro::em.email'); ?></td>
                                            <td
                                                style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;">
                                                <?php echo e($mail['user']['email']); ?></td>
                                        </tr>
                                    </table>
                                </div>
                                <!--[if mso]>
              ...
              <![endif]-->
                        ...
                        <tr>
                            <td
                                ...
                                <p style="margin:0;font-size:16px;line-height:30px;"><span>©</span> <?php echo e(date('Y')); ?> 
...
<?php /**PATH /var/www/vhosts/getyourticket.events/httpdocs/public/resources/views/email_templates/becomeOrganizer.blade.php ENDPATH**/ ?>