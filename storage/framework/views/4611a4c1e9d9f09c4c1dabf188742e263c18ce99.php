                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <?php $__currentLoopData = $dataTypeRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if(Auth::user()->hasRole('admin') && $row->field == 'avatar' && $dataTypeContent->role_id != 1): ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/getyourticket.events/httpdocs/public/eventmie-pro/src/../resources/views/vendor/voyager/users/edit-add.blade.php ENDPATH**/ ?>